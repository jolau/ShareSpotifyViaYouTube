...
public class YouTubeSearchServiceTask extends AsyncTask<Object, Void, Object[]> implements
        ServiceTaskInterface {
    private static final String TAG = YouTubeSearchServiceTask.class.getSimpleName();
    ...
    public YouTubeSearchServiceTask(int iReqCode) {
